// ─────────────────────────────────────────────────────────────
// data/destinations.js — 고를 수 있는 여행지 40곳
//
// 여행지 "목록"만 하드코딩돼 있고, 각 도시의 장소 데이터는 전부 실시간이다.
// 도시 이름과 좌표만 있으면 서버가 그 도시의 장소 풀을 만들어 준다.
//
// 좌표(lat·lng)는 장식이 아니다 — TourAPI 반경 검색의 중심점이자
// 날씨 조회 지점, 지도 초기 중심으로 쓰인다.
//
// 쓰는 곳: DestinationsScreen · SketchKoreaMap · useCityHighlights
// ─────────────────────────────────────────────────────────────
