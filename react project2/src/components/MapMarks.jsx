// ─────────────────────────────────────────────────────────────
// components/MapMarks.jsx — 카카오맵·네이버지도 브랜드 마크
//
// "카카오맵에서 열기" 같은 버튼 옆에 붙는 작은 로고.
// 이미지 파일 대신 인라인 SVG 라서 추가 네트워크 요청이 없고 크기도 자유롭다.
//
// 쓰는 곳: ScheduleTimeline · PlaceDetailModal (외부 지도 연결 버튼)
// ─────────────────────────────────────────────────────────────
