// ─────────────────────────────────────────────────────────────
// hooks/useNearbyParking.js — 장소 주변 주차장 조회
//
// 좌표를 소수점 4자리로 잘라 캐시 키로 쓴다(약 11m 단위). 같은 장소를 다시 눌렀을 때
// 부동소수점 끝자리 차이로 캐시를 빗나가는 일을 막기 위해서다.
//
// 실패도 빈 배열로 캐시한다 — 안 그러면 주차장이 없는 지역에서 장소를 누를 때마다
// 계속 재요청하게 된다.
//
// 쓰는 곳: PlaceDetailModal
// ─────────────────────────────────────────────────────────────
