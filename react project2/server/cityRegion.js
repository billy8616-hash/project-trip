// ─────────────────────────────────────────────────────────────
// server/cityRegion.js — 이 장소가 정말 그 도시에 있는지 확인
//
// 외부 API 는 "속초"로 검색해도 인근 다른 도시의 장소를 섞어 주기도 한다.
// 주소에 도시명이 들어 있는지만 보면 "대포항"처럼 도시명이 다른 지명의
// 일부로 들어간 경우를 걸러내지 못한다.
//
// 그래서 행정구역 단위까지 맞춰서 비교한다 — "속초"가 아니라 "속초시"를 찾는다.
// ─────────────────────────────────────────────────────────────
