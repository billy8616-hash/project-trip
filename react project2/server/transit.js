// ─────────────────────────────────────────────────────────────
// server/transit.js — 장소별 대중교통 접근성 판정
//
// 장소마다 가장 가까운 지하철역을 찾아 등급(good·ok·far·none)을 매긴다.
// 이 등급은 코스 생성에서 점수 보정에 쓰인다 — 대중교통 여행인데 역에서 먼 곳만
// 모아 놓으면 실제로 다닐 수 없는 코스가 되기 때문이다.
//
// 카카오 로컬 카테고리 검색(SW8=지하철역)에 좌표를 주면 거리까지 계산해 주므로
// 따로 거리 계산을 하지 않는다.
// ─────────────────────────────────────────────────────────────
