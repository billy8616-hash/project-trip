// ─────────────────────────────────────────────────────────────
// server/weather.js — OpenWeatherMap (현재 날씨 + 5일 예보)
//
// 날씨를 두 가지 용도로 쓴다.
//   현재 날씨  코스 화면 상단 배지 (단순 표시)
//   일자별 예보 코스 생성의 입력 — 비·눈 오는 날은 실내 장소를 우선한다
//
// 두 번째가 이 앱에서 날씨를 쓰는 진짜 이유다. 예보는 5일치까지만 나오므로
// 그보다 먼 날짜는 "정보 없음"으로 처리하고 날씨를 반영하지 않는다.
// ─────────────────────────────────────────────────────────────
