// ─────────────────────────────────────────────────────────────
// server/costTier.js — 요금 정보를 비용 등급으로 바꾸기
//
// 외부 API 가 주는 요금 정보는 형식이 제각각이다. TourAPI 는 "성인 3,000원,
// 청소년 2,000원" 같은 자유 문장이고, Google 은 PRICE_LEVEL_MODERATE 같은 상수다.
// 둘 다 free·low·mid·high 네 등급으로 통일한다.
//
// 기준선(5천원 미만 low, 1만5천원 이하 mid)은 국내 관광지 입장료 분포를 보고 잡았다.
//
// 쓰는 곳: placeCache 에 저장할 때 → lib/cost.js 가 예산 점수 보정에 사용
// ─────────────────────────────────────────────────────────────
